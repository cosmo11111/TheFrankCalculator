...
st.markdown(f"""<div class="tbl-header" style="display: grid; grid-template-columns: 1.2fr 1.8fr 0.8fr 0.8fr 1fr 0.8fr 1fr 0.8fr 0.4fr; gap: 0; padding: 0 12px 8px; margin-bottom: 10px; border-bottom: 1px solid #e5e5e5;">
    <span>Ticker</span>
    <span>Company</span>
    <span>Units</span>
    <span class="r">Price</span>
    <span class="r">Value</span>
    <span class="r">{yield_label}</span>
    <span class="r">{income_label}</span>
